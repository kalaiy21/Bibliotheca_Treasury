...
function TableRow(props){
    ...
    <div className="mx-10 text-white desktop:text-[1.5rem] laptop:text-[1.3rem] minilap:text-[1.3rem] tablet:text-[1rem] phone:text-[1rem] smphone:text-[0.8rem] smphone:w-[100%] font-light grid grid-cols-[.5fr,2fr,2fr,2fr,2fr]  bg-[#141518] border-[1px] border-[#8D795B] m-0.5">
