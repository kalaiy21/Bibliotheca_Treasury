...
function TableRow(props){
    ...
    <div className=" w-[65rem] mx-10 text-white text-[1.5rem] font-light grid grid-cols-5  bg-[#141518] border-2 border-[#8D795B] m-0.5">
    ...
    <p className= "mx-10 text-white text-[1.5rem] font-light font-Inconsolate text-center border-3 m-2 bg-[#8D795B] border-[#8D795B] w-[10rem]">{props.usdValue}</p>
