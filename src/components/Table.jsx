...
function Tablehead(){
    return(<div className="sticky text-center mx-10 grid grid-cols-[.5fr,2fr,2fr,2fr,2fr] bg-[#141518] top-0">
    <p className="text-[#FBFBFB] p-3 font-Inconsolata text-2xl font-light tracking-[3px]">id</p>
