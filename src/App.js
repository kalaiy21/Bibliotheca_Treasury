...
function App() {
  ...
  return (
    <div className="py-[4rem] px-[8rem] tablet:px-[4rem] smphone:px-[2rem]">
      ...
      <div className="font-Inconsolata flex items-center justify-between mb-[5rem] tablet:flex-col-reverse laptop:flex-row">
        ...
        <img className="phone:p-2 standard:w-[27rem] standard:h-[25rem] desktop:w-[25rem] desktop:h-[23rem] laptopo:w-[23rem] laptop:h-[21rem] minilap:w-[19rem] minilap:h-[18rem] tablet:w-[15rem] tablet:h-[15rem] phone:w-[15rem] phone:h-[14rem] smphone:w-[13rem] smphone:h-[12rem] tablet:mb-[2rem]" src={logo} alt="treasury image" />
      </div>
